...
public class chocolate extends item {
    ...
    public chocolate() {
        ...
        this.feelsLike = "the wrapper crinkles under you hand, you can feel 6 rows of 3 squares, 18 delicious bites";   // maybe give a count for pieces left at some point - can be eaten one by one
