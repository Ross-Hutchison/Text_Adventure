...
public class tutorialRoom extends room {
    ...
    public tutorialRoom() {
        ...
        this.description = "the room is small and rather dull, the walls are grey brick, \n" +
    ...
    public tutorialRoom(String description, item[] items, obstacle[] obstacles, HashMap<item, obstacle> blockedBy, HashMap<String, item> itemIsToItem){
        super(description, items, obstacles, blockedBy, itemIsToItem);
    }
}
